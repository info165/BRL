    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
        <div className="absolute inset-0 z-0">
          ...
          <img src={roboWarArenaImg} alt="Arena" className="absolute right-0 top-0 h-full w-[55%] object-cover object-center" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-28 w-full">
          <motion.div initial="hidden" animate="show" variants={stagger} className="max-w-2xl">
            ...
            <motion.div variants={fadeUp} className="flex items-center gap-3 mb-6">
              ...
              <span className="font-display text-xs font-bold tracking-[0.25em] uppercase text-[#00a8ff]">FunScholar presents</span>
            </motion.div>

            {/* BHARAT ROBOTICS LEAGUE */}
            <motion.div variants={fadeUp} className="mb-2">
              <h1 className="font-display font-black uppercase leading-[0.92] tracking-tight">
                <span className="block text-5xl sm:text-6xl md:text-7xl text-white">BHARAT</span>
                <span className="block text-[clamp(3.5rem,10vw,6rem)] relative"
                  style={{
                ...
                <span className="block text-5xl sm:text-6xl md:text-7xl"
                  style={{ color: "#fac800", textShadow: "0 0 30px rgba(250,200,0,0.5)" }}>LEAGUE</span>
              </h1>
            </motion.div>

            {/* Season + theme */}
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3 mt-5 mb-2">
              <span className="font-display font-black text-xs tracking-[0.2em] uppercase bg-[#00a8ff] text-[#030912] px-3 py-1 rounded-sm">SEASON 1</span>
              <span className="font-display font-bold text-white/40 text-xs tracking-widest uppercase">2026</span>
              <span className="w-1 h-1 rounded-full bg-white/20" />
              <span className="font-display font-black text-xl tracking-wider uppercase text-[#ff3333]"
                style={{ textShadow: "0 0 16px rgba(255,50,50,0.6)" }}>DANGAL</span>
            </motion.div>

            <motion.p variants={fadeUp} className="font-display font-bold text-sm uppercase tracking-[0.15em] text-white/40 mb-2">
              Season Theme: <span className="text-white/60">Dangal of Robots</span>
            </motion.p>
            ...
            {/* Sub-nav to pages */}
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4 mt-5">
              <Link href="/registration"
                className="text-xs font-display font-bold uppercase tracking-wider text-white/40 hover:text-[#00a8ff] transition-colors flex items-center gap-1">
                Registration Info <ChevronRight className="w-3 h-3" />
              </Link>
              <Link href="/robot-specs"
                className="text-xs font-display font-bold uppercase tracking-wider text-white/40 hover:text-[#00a8ff] transition-colors flex items-center gap-1">
                Robot Specs <ChevronRight className="w-3 h-3" />
              </Link>
              <Link href="/rules"
                className="text-xs font-display font-bold uppercase tracking-wider text-white/40 hover:text-[#00a8ff] transition-colors flex items-center gap-1">
                General Rules <ChevronRight className="w-3 h-3" />
              </Link>
            </motion.div>
          </motion.div>
        </div>
